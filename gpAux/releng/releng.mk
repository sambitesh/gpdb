...
ifeq "$(findstring aix,$(BLD_ARCH))" ""
	LD_LIBRARY_PATH='' wget --no-check-certificate -q -O - https://github.com/bhuvnesh2703/gporca/releases/download/v3.20.0/bin_orca_centos5_release.tar.gz | tar zxf - -C $(BLD_TOP)/ext/$(BLD_ARCH)
endif
